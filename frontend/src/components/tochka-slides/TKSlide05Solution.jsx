...
const steps = [
  ...
  },
  {
    ...
    items: ["Разбивка на темы и смысловые блоки", "Извлечение решений, задач и выводов", "Учёт дополнительных файлов и контекста", "Применение AI-сценариев анализа"],
  },
  {
    n: "03", t: "Рабочий результат",
    items: ["Структурированный документ для бизнес-процессов", "Материалы для CRM, КП, ТЗ или отчёта", "Выводы, рекомендации и задачи по исполнителям", "Экспорт в DOCX / PDF, шаринг по ссылке"],
  },
];
