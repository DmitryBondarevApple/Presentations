    ...
    <div className="w-full h-full flex flex-col relative bg-background">
      ...
      <div className="flex-1 overflow-y-auto flex flex-col items-center justify-start lg:justify-center px-6 py-6 md:py-10 relative z-10">
        <div className="animate-item stagger-1 mb-6 md:mb-10">
          <span className="font-heading text-xl md:text-3xl lg:text-4xl tracking-[0.3em] text-foreground font-bold">
        ...
        <h1 className="animate-item stagger-3 font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground text-center max-w-5xl leading-tight" data-testid="fc-title">
          ИИ как часть пакета{' '}
