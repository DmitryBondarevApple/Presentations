...
export const EMSlideContainer = ({ children, number, label, className }) => {
  return (
    <div className={cn(
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle at top right, hsl(82 84% 55%), transparent 70%)' }}
      />
      <div
        className="absolute bottom-0 left-0 w-60 h-60 opacity-[0.03] pointer-events-none"
        style={{ background: 'radial-gradient(circle at bottom left, hsl(82 84% 55%), transparent 70%)' }}
      />
