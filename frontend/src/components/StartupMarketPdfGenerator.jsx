...
const S27 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={27} label="Рекомендации · Назначение раздела" />
...
const S28 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={28} label="Рекомендации · Инвесторы" />
...
const S29 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={29} label="Рекомендации · Инвесторы" />
...
const S31 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={31} label="Рекомендации · Корпорации" color={T.terra} />
...
const S32 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={32} label="Рекомендации · Корпорации" color={T.terra} />
    ...
    <Cols gap={22}>
      ...
      <Col>
        ...
        <TableC accent={T.terra} headers={["Направление", "Почему важно"]} weights={[1.3, 2]}
          rows={[
            ["Enterprise SaaS", "Прямая применимость к цифровизации процессов, данным, аналитике и автоматизации"],
...
const S34 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={34} label="Рекомендации · Институты развития" color={T.green} />
...
const S35 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={35} label="Рекомендации · Институты развития" color={T.green} />
...
const S37 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={37} label="Рекомендации · Стартапы" />
...
const S38 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={38} label="Рекомендации · Стартапы" />
...
const S39 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={39} label="Рекомендации · Сводка" />
...
const S40 = () => (
  <Page size={[PW, PH]} style={ps()}><Header num={40} label="Рекомендации · Сводка" color={T.terra} />
...
const S41 = () => (
  <Page size={[PW, PH]} style={{ ...f, width: PW, height: PH, backgroundColor: T.bg, padding: "28 44", color: T.fg }}>
    <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
      ...
      <Text style={{ fontSize: 9, color: T.muted, letterSpacing: 1 }}>41 / 41</Text>
    </View>
