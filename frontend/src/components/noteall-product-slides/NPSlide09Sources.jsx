...
const NPSlide09Sources = () => (
  <NPSlideContainer number={9} label="Источники данных">
    ...
    <p className="font-body text-sm sm:text-base md:text-xl text-muted-foreground mb-2 sm:mb-5 md:mb-10 leading-snug sm:leading-relaxed max-w-5xl">
      Аудио и видео файлы, ссылки на видеохостинги, документы и внешние ресурсы — единая точка входа для всего контента.
    </p>
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-6">
      {[
        { title: "Записи встреч", desc: "Загрузите аудио или видео — любой формат. Полная транскрибация с определением спикеров и анализ по выбранному сценарию.", tags: ["MP3", "MP4", "WAV", "WebM"] },
        { title: "Видео-хостинги", desc: "Вставьте ссылку на YouTube или Instagram — система скачает видео, извлечёт аудио, ключевые кадры и выполнит полный анализ.", tags: ["YouTube", "Instagram"] },
