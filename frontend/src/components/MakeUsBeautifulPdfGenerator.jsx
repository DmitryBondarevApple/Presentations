...
/* ═══════════════════════════════════════════════════════ */
const steps = [
  { n: "01", t: "Замер", d: "Выезд, анализ входной группы, фото" },
  { n: "02", t: "Концепция", d: "Эскиз + смета под ваш стиль" },
  { n: "03", t: "Согласов.", d: "Требования УК и собственника" },
  { n: "04", t: "Закупка", d: "Материалы и крепёж" },
  { n: "05", t: "Монтаж", d: "Установка, проверка, подсветка" },
  { n: "06", t: "Сдача", d: "Уборка, фото, приёмка" },
  { n: "07", t: "Демонтаж", d: "После окончания сезона" },
];
const S6 = () => (
  <Page size={[PW, PH]} style={pg}>
    ...
    <View style={{ flexDirection: "row", gap: 10 }}>
      {steps.map((st, i) => (
        <View key={i} style={{
          ...
          <Text style={{ fontSize: 12, fontWeight: 700, color: T.accent, opacity: 0.7 }}>{st.n}</Text>
          <Text style={{ fontSize: 15, fontWeight: 700, color: T.fg, marginTop: 10 }}>{st.t}</Text>
          <Text style={{ fontSize: 11, color: T.muted, marginTop: 8, lineHeight: 1.5 }}>{st.d}</Text>
        </View>
      ))}
    </View>
