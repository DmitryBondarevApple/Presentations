  ...
  <SlideContainer number={12} label="Дорожная карта">
    ...
    <div className="w-full space-y-2.5">
      ...
      <div className="flex items-center">
        <div className="w-[160px] md:w-[220px] lg:w-[260px] shrink-0" />
      ...
      {stages.map((stage, i) => {
        ...
        return (
          ...
          >
            <span className="font-body text-xs md:text-sm text-foreground/75 w-[160px] md:w-[220px] lg:w-[260px] shrink-0 pr-4 text-right truncate">
              {stage.name}
            </span>
    ...
    <p className="animate-item stagger-9 mt-6 font-body text-[10px] md:text-xs text-muted-foreground/50">
