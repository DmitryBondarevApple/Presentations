...
const TasksSlide = () => (
  <SlideContainer number={5} label="Задачи">
    <h2 className="animate-item stagger-1 font-heading text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-5 max-w-5xl">
      {tasks.map((task, i) => (
        ...
        >
          <span className="font-heading text-sm font-bold text-accent shrink-0 w-7 mt-0.5">
