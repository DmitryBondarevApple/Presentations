...
const GoalSlide = () => (
  <SlideContainer number={4} label="Цель программы">
    <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
      ...
      <h2 className="animate-item stagger-2 font-heading text-2xl sm:text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-foreground leading-snug">
      ...
      <p className="animate-item stagger-4 mt-8 font-body text-base md:text-lg text-muted-foreground max-w-2xl leading-relaxed">
