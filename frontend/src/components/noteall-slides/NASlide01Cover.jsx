  ...
  <div className="w-full h-full flex flex-col relative bg-background">
    ...
    <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center px-4 sm:px-6 py-6 md:py-10 relative z-10">
      <div className="animate-item stagger-1 mb-4 md:mb-10">
        <img src={`${process.env.PUBLIC_URL || ''}/images/noteall/logo-noteall.png`} alt="Noteall" className="h-10 sm:h-14 md:h-24" data-testid="na-logo" />
      </div>
      ...
      <h1 className="animate-item stagger-3 font-heading text-xl sm:text-2xl md:text-5xl lg:text-6xl font-bold text-foreground text-center max-w-5xl leading-tight" data-testid="na-title">
