const NASlide01Cover = () => (
  <div className="w-full h-full flex flex-col relative bg-background">
    ...
    <div className="flex-1 overflow-y-auto flex flex-col items-center justify-start lg:justify-center px-6 py-6 md:py-10 relative z-10">
      <div className="animate-item stagger-1 mb-4 md:mb-8">
        <img src={`${process.env.PUBLIC_URL || ''}/images/noteall/logo-noteall.png`} alt="NoteAll" className="h-12 md:h-20" data-testid="na-logo" />
      </div>
      <div className="animate-item stagger-2 mb-3 md:mb-5">
      ...
      <p className="animate-item stagger-4 mt-3 md:mt-6 font-body text-sm md:text-xl text-muted-foreground text-center max-w-3xl leading-relaxed">
      ...
      <p className="animate-item stagger-5 mt-3 md:mt-4 font-body text-xs md:text-base text-muted-foreground/60 text-center max-w-2xl">
