...
import EMSlide01Cover from '@/components/emergent-slides/EMSlide01Cover';
import EMSlide02Known from '@/components/emergent-slides/EMSlide02Known';
import EMSlide03About from '@/components/emergent-slides/EMSlide03About';
import EMSlide04Path from '@/components/emergent-slides/EMSlide04Path';
import EMSlide05Map from '@/components/emergent-slides/EMSlide05Map';
import EMSlide06Idea from '@/components/emergent-slides/EMSlide06Idea';
import EMSlide07Problem from '@/components/emergent-slides/EMSlide07Problem';
import EMSlide08Market from '@/components/emergent-slides/EMSlide08Market';
import EMSlide09Requirements from '@/components/emergent-slides/EMSlide09Requirements';
import EMSlide10Emergent from '@/components/emergent-slides/EMSlide10Emergent';
import EMSlide11Team from '@/components/emergent-slides/EMSlide11Team';
import EMSlide12Tasks from '@/components/emergent-slides/EMSlide12Tasks';
...
const allSlides = [
  EMSlide01Cover, EMSlide02Known, EMSlide03About, EMSlide04Path,
  ...
  EMSlide22DomainValue, EMSlide20Environments, EMSlide21Pipeline, EMSlide23HumanRole,
];
...
export default function EmergentPresentation() {
  ...
  const generatePdf = useCallback(async () => {
    ...
    try {
      await generateEmergentPdf((msg) => setPdfProgress(msg));
  ...
  return (
    <div
      ...
      data-testid="emergent-presentation"
    >
      ...
      <div className={cn(
        ...
        {current > 0 && (
          <Button variant="ghost" size="icon" onClick={goPrev} data-testid="em-prev-btn"
      ...
      <div className={cn(
        ...
        {current < TOTAL - 1 && (
          <Button variant="ghost" size="icon" onClick={goNext} data-testid="em-next-btn"
            className="h-11 w-11 rounded-full bg-foreground/5 hover:bg-foreground/10 text-foreground/50 hover:text-foreground">
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-1.5">
          {allSlides.map((_, i) => (
            <button key={i} onClick={() => goTo(i)} data-testid={`em-dot-${i}`}
              className={cn(
                "h-1.5 rounded-full",
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button variant="ghost" size="icon" onClick={toggleFs} data-testid="em-fullscreen-btn"
